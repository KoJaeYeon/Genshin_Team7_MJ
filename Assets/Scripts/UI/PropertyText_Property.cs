    ...
    public void UpdatePanel()
    {
        switch (EquipManager.Instance.character)
        {
            case CharacterItemSprite.Beidou:
                ...
                powerCount.text = ((int)((characterData[0].baseAtk + Beidou_EquipStats.weaponDamage) * (1 + (Beidou_EquipStats.trohphy_AttackPercent) / 100f))).ToString();
            ...
            case CharacterItemSprite.Kokomi:
                ...
                powerCount.text = ((int)((characterData[1].baseAtk + Kokomi_EquipStats.weaponDamage) * (1 + (Kokomi_EquipStats.trohphy_AttackPercent) / 100f))).ToString();
            ...
            case CharacterItemSprite.Wriothesley:
                ...
                powerCount.text = ((int)((characterData[2].baseAtk + Wrio_EquipStats.weaponDamage) * (1 + (Wrio_EquipStats.trohphy_AttackPercent) / 100f))).ToString();
            ...
            case CharacterItemSprite.Yoimiya:
                ...
                powerCount.text = ((int)((characterData[3].baseAtk + Yoimiya_EquipStats.weaponDamage) * (1 + (Yoimiya_EquipStats.trohphy_AttackPercent) / 100f))).ToString();
